...
let userInput = window.prompt("Guess a number from 1 and 100.");
...
switch (cheese.toLocaleLowerCase()) {
    ...
    break;
    case "asiago":
        console.log("You, my friend, have great taste");
        break;
        case "gouda":
            console.log("That's some GOUDA cheese ;");
            break;
            case "mozzarella":
                console.log("Mozarella is a traditionally southern Italian cheese made from Italian buffalo's milk");
                break;
                default:
